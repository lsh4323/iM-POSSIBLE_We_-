...
fun HomeRoute(
    ...
    HomeScreen(
        ...
        onAnimalIntroductionClick = viewModel::showAnimalIntroductionPopup,
...
fun HomeScreen(
    ...
    BoxWithConstraints(
        ...
        MenuButton(
            isCloseMode = uiState.isAlarmEnabled || uiState.isAnimalIntroductionVisible,
            onClick = {
                if (uiState.isAlarmEnabled || uiState.isAnimalIntroductionVisible) {
                    onDisableAlarm()
                } else {
                    onMenuClick()
                }
    ...
    MyApplicationTheme {
        HomeScreen(
            uiState = HomeUiState(
                ...
                isAnimalIntroductionPopupVisible = true
            ),
            onHouseClick = {},
            onMenuClick = {},
            onDisableAlarm = {},
